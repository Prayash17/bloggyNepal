...
// ─── Reveal-on-scroll hook (lightweight, no framer-motion needed) ──────
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fbfaf7] text-slate-900">
      ...
      <footer
        id="newsletter"
        className="border-t border-stone-200 bg-[#f1ede4] px-6 py-20 sm:px-8"
      >
        <div className="mx-auto max-w-7xl">
          {/* Newsletter CTA */}
          <div className="mb-16 rounded-3xl border border-stone-300 bg-white p-8 shadow-sm sm:p-12">
            <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:items-center">
              <div>
                ...
                <h3 className="mt-3 font-serif text-3xl font-bold text-slate-900 sm:text-4xl">
                  One slow-travel email a month. Zero spam.
                </h3>
                <p className="mt-3 max-w-md text-slate-600">
                  Honest guides, route notes, and stories from the road —
                  delivered when there's something worth saying.
                </p>
              </div>
              <form className="flex flex-col gap-3 sm:flex-row">
                <input
                  ...
                  className="flex-1 rounded-full border border-stone-300 bg-[#fbfaf7] px-5 py-4 text-slate-900 outline-none transition focus:border-amber-400 focus:ring-4 focus:ring-amber-200/40"
                />
                <button
                  type="submit"
                  className="group inline-flex items-center justify-center gap-2 rounded-full bg-slate-950 px-6 py-4 font-bold text-white transition hover:bg-red-800"
                >
                  Subscribe
